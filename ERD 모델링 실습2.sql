...
insert into `patients` (`pat_id`, `doc_id`, `nur_id`,`pat_name`, `pat_jumin`, `pat_gen`, `pat_addr`, `pat_phone`, `pat_email`, `pat_job`) values
('P104101', 'D104101', 'N104101', '이나영', '790413-1234567', 'F', '대전', '0102101-7904', 'lee@naver.com', '회사원');
insert into `patients` (`pat_id`, `doc_id`, `nur_id`,`pat_name`, `pat_jumin`, `pat_gen`, `pat_addr`, `pat_phone`, `pat_email`, `pat_job`) values
...
insert into `patients` (`pat_id`, `doc_id`, `nur_id`,`pat_name`, `pat_jumin`, `pat_gen`, `pat_addr`, `pat_phone`, `pat_email`, `pat_job`) values
('P104102', 'D104101', 'N104101', '고소영', '840615-1234567', 'M', '대구', '010-4101-8406', 'goso@daum.net', '회사원');
insert into `patients` (`pat_id`, `doc_id`, `nur_id`,`pat_name`, `pat_jumin`, `pat_gen`, `pat_addr`, `pat_phone`, `pat_email`, `pat_job`) values
('P108101', 'D108101', 'N108101', '김연아', '651021-1234567', 'M', '대구', '010-5101-6510', 'yuna@daum', '운동선수');
insert into `patients` (`pat_id`, `doc_id`, `nur_id`,`pat_name`, `pat_jumin`, `pat_gen`, `pat_addr`, `pat_phone`, `pat_email`, `pat_job`) values
...
values('N101101', '송승헌', '1976-03-14', 'M', '101', '수간호사', '010-1101-7602','ssh@bw.com');
insert into `Nurses` (`nur_id`, `nur_name`, `nur_birth`, `nur_gender`, `dep_no`, `nur_pos`, `nur_phone`, `nur_email`)
...
insert into `Nurses` (`nur_id`, `nur_name`, `nur_birth`, `nur_gender`, `dep_no`, `nur_pos`, `nur_phone`, `nur_email`)
values('N103101', '정준하', '1966-10-12', 'M', '103', '주임','010-1104-6610', 'jung@bw.com');
insert into `Nurses` (`nur_id`, `nur_name`, `nur_birth`, `nur_gender`, `dep_no`, `nur_pos`, `nur_phone`, `nur_email`)
...
insert into `charts` values('C101002', '1031002', 'D103101', 'P103101', '입원 치료');
...
#모든 의사 id,이름 생년월일, 전공의과 번호 전공의과 이름
select
`doc_id`,
`doc_name`,
`doc_birth`,
...
#모든 간호사의 간호사 id, 이름 생년월일 전공의과 번호 전공의과 이름
SELECT 
	`nur_id`,
	`nur_name`,
	`nur_birth`,
...
#3 모든 환자의 id 이름 주민번호, 휴대폰 담당의사 이름,. 담당 간호사 이름
SELECT
	`pat_id`,
	`pat_name`,
	`pat_jumin`,
...
#4모든 진료내역에서 환자 이름, 담담의사이름, 진료내용, 처방내용, 진료날짜 조회
SELECT
	`pat_name`,
	`doc_name`,
	`treat_contents`,
